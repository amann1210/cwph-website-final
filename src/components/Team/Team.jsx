...
const getPastCo = async () => {

  let data = await getDocs(PastCoCollectionRef);
  data = (data.docs.map((doc) => ({ ...doc.data(), id: doc.id })));
   console.log(data);
  setPastCo(data);
};
        ...
        <div className="container-fluid">
          <div className="row justify-content-center">
            ...
            {teamList.map((team, i) => (
              ...
              <div className="container">
               { team.designation == "Present Co-ordinators"?
                <div className="row justify-content-center">{PresentCo.map((member) => (
                  (<div className=" col-xxl-2 col-lg-3 col-md-4 col-sm-6 col-xs-12 " key={member.link}>
                    <div className="team-item">
                      <img src={member.link} alt="ITS MAGIC" />
                      <div className="down-content">
                        <h4>{member.title}</h4>
                        <span>{member.responsibility}</span>
                      </div>
             ...
             <div className="container">
               { team.designation == "Past Co-ordinators"?
                  <div className="row justify-content-center">{PastCo.map((member) => (
                  (<div className=" col-xxl-2 col-lg-3 col-md-4 col-sm-6 col-xs-12" key={member.link}>
                    <div className="team-item">
                      <img src={member.link} alt="ITS MAGIC" />
                      <div className="down-content">
